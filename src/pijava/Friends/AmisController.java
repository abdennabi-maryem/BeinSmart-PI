...
public class AmisController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
      ...
      public void AffichList() {
        ...
        ObservableList<Utilisateur> usersList = SF.AfficherAmis(UserSession.getID());
        ...
        listView.setCellFactory((Callback<ListView<Utilisateur>, ListCell<Utilisateur>>) param -> {
            return new ListCell<Utilisateur>() {
                ...
                loader.setLocation(getClass().getResource("/pijava/UsersFront/UserProfil.fxml"));
                try {
                        loader.load();
                    ...
                    // 
                       ...
                       Button SupprimerBTN  = new Button("Supprimer");
                        ...
                        Hbx.getChildren().add(SupprimerBTN);
    ...
    @FXML
    private void RequestBtnClicked(MouseEvent event) {
        Node node = (Node) event.getSource();
        Stage stage = (Stage) node.getScene().getWindow();
        FXMLLoader loader = new FXMLLoader ();
        loader.setLocation(getClass().getResource("/pijava/Friends/DemandeAmis.fxml"));
        try {
        loader.load();
