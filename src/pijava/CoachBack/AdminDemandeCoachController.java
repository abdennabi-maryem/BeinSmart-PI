 ...
 * @author 21699
 */
public class AdminDemandeCoachController implements Initializable {
    ...
    public void AffichList() {
        ...
        ObservableList<Coach> coachList = SC.AfficherDemande();
        ...
        listView.setCellFactory((Callback<ListView<Coach>, ListCell<Coach>>) param -> {
            return new ListCell<Coach>() {
                ...
                protected void updateItem(Coach c, boolean empty) {
                    ...
                    // Username + Filiere + experience + region Label
                ...
                try {
                    ...
                    //
                        ...
                        Optional <ButtonType> action = alert.showAndWait();
                          ...
                          SC.SupprimerCoach(c);
                          SU.Notification(c.getId(),2);
                          AffichList();
                            }
                        });
                        Hbx.getChildren().addAll(AccBTN, SuppBTN);
